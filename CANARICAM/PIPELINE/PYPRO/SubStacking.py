...
def Stack1(fileName,NOD,listaA,listaB,i):
...
def Stack2(fileName,NNODSETS,NNODS,i,hdr,bfname):
	#####  Combination of NODS
	try:
		os.remove('kk1.fits')
	except os.error:
	...
	final[2]=resta
	try:
		os.remove(bfname+fileName)
	except os.error:
		pass
	pyfits.writeto(bfname+fileName,final,hdr)
	try:
		os.remove('kk1.fits')
	except os.error:
		pass
