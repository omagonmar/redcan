...
begin
    ...
    while (i <= nimages) {
        ...
        nhedit (tmpim5//".fits", "AIRMASS", airmass1, "Airmass", comfile="NULL",
            after="", before="", update+, add+, addonly-, delete-, verify-,
            show-)
        nhedit (tmpim3//".fits", "AIRMASS", airmass2, "Airmass", comfile="NULL",
            after="", before="", update+, add+, addonly-, delete-, verify-,
            show-)
        ...
        if (!l_fl_bbody) {
            ...
            nhedit (tmpim7//".fits", "CRVAL1", airmass1, ".", comfile="NULL",
                after="", before="", update+, add+, addonly-, delete-,
                verify-, show-)
            nhedit (tmpim7//".fits", "CDELT1", airmass2, ".", comfile="NULL",
                after="", before="", update+, add+, addonly-, delete-,
                verify-, show-)
        ...
        nhedit (out[i]//"[1]", "EXTNAME", "SCI", "Extension name",
            comfile="NULL", after="", before="", update+, add+, addonly-,
            delete-, verify-, show-)
        nhedit (out[i]//"[1]", "EXTVER", 1, "Extension version", comfile="NULL",
            after="", before="", update+, add+, addonly-, delete-, verify-,
            show-)

        gemdate ()
        nhedit (out[i]//"[0]", "MSABSFLUX", gemdate.outdate,
            "UT Time stamp for MSABSFLUX", comfile="NULL", after="", before="",
