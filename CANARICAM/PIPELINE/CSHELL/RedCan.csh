...
csh -f ${dirshell}/InitialRedCan.csh $infile $entry_point $method $target_ext $radial_profile $offset $modify
...
if (${instrument} == "CC" && ${firstline} != "S") then
	...
	echo "*************************************" >> ${startdir}/PRODUCTS/Status_${infilen}.txt
	csh -f ${dirshell}/ChangeName.csh ${infile}
        echo "New list: "
	echo "--------  "
	cat $infile
endif 
...
#python ${dirpython}/Stacking_iraf_registerNEW.py ${procmidir}/ ${startdir}/${infile} ${check_back}  >> ${startdir}/PRODUCTS/Status_${infilen}.txt
...
### If redshifts.lst is operated by hand... 
if (-e ${startdir}/PRODUCTS/redshifts.lst) then
   cp ${startdir}/PRODUCTS/redshifts.lst ${startdir}/PRODUCTS/redshifts_${infilen}.lst
endif
more ${startdir}/PRODUCTS/redshifts_${infilen}.lst
...
echo 'XtractMain, "'${infilen}'", "stck","'${dircohen}'",'${target_ext}', METHOD='${method}', SIGMAS='${sigmas}', OFFSET=['${offset}'], TEXTFILE="'${infilen}'.txt", NCOLAPSING='${ncolapsing}', RADIAL_PROFILE=['${radial_profile}'], INSTRUMENT="'${instrument}'"' >> PRODUCTS/Xtm_tmp.pro
echo "Running idl..."
