...
IF KEYWORD_SET(vertical) THEN BEGIN
   ...
   IF KEYWORD_SET(right) THEN BEGIN
      ...
      PLOT, [min,max], [min,max], /NODATA, XTICKS=1, $
         ...
         YRANGE=[min, max], YTITLE=title,CHARTHICK=charthick
   ...
   ENDIF ELSE BEGIN
      ...
      PLOT, [min,max], [min,max], /NODATA, XTICKS=1, $
         ...
         YRANGE=[min, max],CHARTHICK=charthick

      AXIS, YAXIS=1, YRANGE=[min, max], YTICKFORMAT='(A1)', YTICKS=divisions, $
         YTICKLEN=0.1, YTITLE=title, YSTYLE=1, COLOR=color, $
...
ENDIF ELSE BEGIN
   ...
   IF KEYWORD_SET(top) THEN BEGIN
      ...
      PLOT, [min,max], [min,max], /NODATA, XTICKS=divisions, $
         ...
         XRANGE=[min, max], XTITLE=title,CHARTHICK=charthick

      AXIS, XTICKS=divisions, XSTYLE=1, COLOR=color, CHARSIZE=charsize, $
         XTICKFORMAT=format, XTICKLEN=0.1, XRANGE=[min, max], XAXIS=1,CHARTHICK=charthick
   ...
   ENDIF ELSE BEGIN
      ...
      PLOT, [min,max], [min,max], /NODATA, XTICKS=divisions, $
         ...
         XRANGE=[min, max], TITLE=title,CHARTHICK=charthick
