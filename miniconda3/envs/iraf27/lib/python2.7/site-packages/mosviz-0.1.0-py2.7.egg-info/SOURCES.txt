...
astropy_helpers/astropy_helpers/commands/_test_compat.py
astropy_helpers/astropy_helpers/commands/build_ext.py
astropy_helpers/astropy_helpers/commands/build_py.py
astropy_helpers/astropy_helpers/commands/build_sphinx.py
astropy_helpers/astropy_helpers/commands/install.py
astropy_helpers/astropy_helpers/commands/install_lib.py
astropy_helpers/astropy_helpers/commands/register.py
...
astropy_helpers/astropy_helpers/extern/numpydoc/linkcode.py
...
astropy_helpers/astropy_helpers/sphinx/local/python2_local_links.inv
...
docs/make.bat
docs/readingindata.rst
docs/_templates/autosummary/base.rst
docs/_templates/autosummary/class.rst
docs/_templates/autosummary/module.rst
docs/images/MOSViz_screenshot_labeled_flt_crp.png
docs/images/MOSViz_wizard.png
docs/images/mosviz_screenshot.png
docs/images/stsci_logo.png
licenses/LICENSE.rst
licenses/README.rst
mosviz/__init__.py
mosviz/_astropy_init.py
mosviz/compat.py
mosviz/conftest.py
mosviz/setup_package.py
mosviz/version.py
mosviz.egg-info/PKG-INFO
mosviz.egg-info/SOURCES.txt
mosviz.egg-info/dependency_links.txt
mosviz.egg-info/entry_points.txt
mosviz.egg-info/not-zip-safe
mosviz.egg-info/requires.txt
mosviz.egg-info/top_level.txt
mosviz/data/ui/cutout_tool.ui
mosviz/data/ui/general_cutout_tool.ui
mosviz/data/ui/layer_widget.ui
mosviz/data/ui/loader_selection.ui
mosviz/data/ui/mos_widget.ui
mosviz/data/ui/table_generator.ui
mosviz/data/ui/icons/External-96.png
mosviz/data/ui/icons/Next-96.png
mosviz/data/ui/icons/Previous-96.png
mosviz/data/ui/icons/Settings-96.png
mosviz/extern/__init__.py
mosviz/loaders/__init__.py
mosviz/loaders/deimos_loaders.py
mosviz/loaders/hst_loaders.py
mosviz/loaders/jwst_loaders.py
mosviz/loaders/loader_selection.py
mosviz/loaders/utils.py
mosviz/loaders/tests/__init__.py
mosviz/loaders/tests/test_mos_loaders.py
mosviz/loaders/tests/data/__init__.py
mosviz/loaders/tests/data/deimos/12004808.acs.v_6ac_.fits.gz
mosviz/loaders/tests/data/deimos/__init__.py
mosviz/loaders/tests/data/deimos/slit.1153.151R.fits.gz
mosviz/loaders/tests/data/deimos/spec1d.1153.151.12004808.fits.gz
mosviz/loaders/tests/data/jwst/2Dspectrum_MOS_1_105_039_CLEAR-PRISM_MOS_PRISM-observation-2-c0e0_000.fits.gz
mosviz/loaders/tests/data/jwst/Final_spectrum_MOS_1_105_039_CLEAR-PRISM_MOS_PRISM-observation-2-c0e0_000.fits.gz
mosviz/loaders/tests/data/jwst/__init__.py
mosviz/loaders/tests/data/jwst/nrc_oct16_969.fits.gz
mosviz/plugins/__init__.py
mosviz/plugins/cutout_tool.py
mosviz/plugins/table_generator.py
mosviz/tests/__init__.py
mosviz/tests/coveragerc
mosviz/tests/setup_package.py
mosviz/utils/__init__.py
mosviz/utils/tests/__init__.py
mosviz/viewers/__init__.py
mosviz/viewers/mos_viewer.py
mosviz/viewers/tests/__init__.py
mosviz/viewers/tests/test_mos_viewer.py
mosviz/widgets/__init__.py
mosviz/widgets/layer_widget.py
mosviz/widgets/plots.py
mosviz/widgets/share_axis.py
mosviz/widgets/toolbars.py
mosviz/widgets/viewer_options.py