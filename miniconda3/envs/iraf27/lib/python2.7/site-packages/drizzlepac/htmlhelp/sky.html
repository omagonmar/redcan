...
<head>
  ...
  <title>Step 3: Subtracting the Sky &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Step 3: Subtracting the Sky</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Step 3: Subtracting the Sky</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/sky.rst.txt" rel="nofollow"> View page source</a>
...
<tbody valign="top">
<tr class="field-odd field"><th class="field-name">Authors:</th><td class="field-body">Christopher Hanley, Megan Sosey, Mihai Cara</td>
</tr>
...
<code class="descclassname">drizzlepac.sky.</code><code class="descname">sky</code><span class="sig-paren">(</span><em>input=None</em>, <em>outExt=None</em>, <em>configObj=None</em>, <em>group=None</em>, <em>editpars=False</em>, <em>**inputDict</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/drizzlepac/sky.html#sky"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#drizzlepac.sky.sky" title="Permalink to this definition">¶</a></dt>
...
the <code class="xref py py-obj docutils literal notranslate"><span class="pre">skymethod</span></code> parameter. This function will update the <code class="docutils literal notranslate"><span class="pre">MDRIZSKY</span></code> keyword
...
<dt><strong>input</strong> <span class="classifier-delimiter">:</span> <span class="classifier">str or list of str (Default = None)</span></dt>
<dd><p class="first last">A python list of image filenames, or just a single filename.</p>
</dd>
<dt><strong>outExt</strong> <span class="classifier-delimiter">:</span> <span class="classifier">str (Default = None)</span></dt>
<dd><p class="first last">The extension of the output image. If the output already exists
then the input image is overwritten.</p>
</dd>
<dt><strong>configObj</strong> <span class="classifier-delimiter">:</span> <span class="classifier">configObject (Default = None)</span></dt>
<dd><p class="first last">An instance of <code class="xref py py-obj docutils literal notranslate"><span class="pre">configObject</span></code></p>
</dd>
<dt><strong>group</strong> <span class="classifier-delimiter">:</span> <span class="classifier">int (Default = None)</span></dt>
<dd><p class="first last">The group of the input image.</p>
</dd>
<dt><strong>editpars</strong> <span class="classifier-delimiter">:</span> <span class="classifier">bool (Default = False)</span></dt>
<dd><p class="first last">A parameter that allows user to edit input parameters by hand in the GUI.</p>
</dd>
<dt><strong>inputDict</strong> <span class="classifier-delimiter">:</span> <span class="classifier">dict, optional</span></dt>
<dd><p class="first">An optional list of parameters specified by the user.</p>
<div class="admonition note">
<p class="first admonition-title">Note</p>
<p class="last">These are parameters that <code class="xref py py-obj docutils literal notranslate"><span class="pre">configObj</span></code> should contain by default. These
parameters can be altered on the fly using the <code class="xref py py-obj docutils literal notranslate"><span class="pre">inputDict</span></code>. If <code class="xref py py-obj docutils literal notranslate"><span class="pre">configObj</span></code>
is set to None and there is no <code class="xref py py-obj docutils literal notranslate"><span class="pre">inputDict</span></code> information, then the values
...
<p>Table of optional parameters that should be in <code class="xref py py-obj docutils literal notranslate"><span class="pre">configobj</span></code> and can also be
specified in <code class="xref py py-obj docutils literal notranslate"><span class="pre">inputDict</span></code>.</p>
...
<tbody valign="top">
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code></td>
<td>‘KEYWORD in header which indicates a sky subtraction value to use’.</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skymethod</span></code></td>
<td>‘Sky computation method’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skysub</span></code></td>
<td>‘Perform sky subtraction?’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skywidth</span></code></td>
<td>‘Bin width of histogram for sampling sky statistics (in sigma)’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skystat</span></code></td>
<td>‘Sky correction statistics parameter’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skylower</span></code></td>
<td>‘Lower limit of usable data for sky (always in electrons)’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyupper</span></code></td>
<td>‘Upper limit of usable data for sky (always in electrons)’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyclip</span></code></td>
<td>‘Number of clipping iterations’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skylsigma</span></code></td>
<td>‘Lower side clipping factor (in sigma)’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyusigma</span></code></td>
<td>‘Upper side clipping factor (in sigma)’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skymask_cat</span></code></td>
<td>‘Catalog file listing image masks’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">use_static</span></code></td>
<td>‘Use static mask for skymatch computations?’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">sky_bits</span></code></td>
<td>‘Bit flags for identifying bad pixels in DQ array’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code></td>
<td>‘KEYWORD indicating a sky subtraction value if done by user’</td>
</tr>
<tr class="row-even"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">skyfile</span></code></td>
<td>‘Name of file with user-computed sky values’</td>
</tr>
<tr class="row-odd"><td><code class="xref py py-obj docutils literal notranslate"><span class="pre">in_memory</span></code></td>
<td>‘Optimize for speed or for memory use’</td>
</tr>
</tbody>
</table>
<p class="last">These optional parameters are described in more detail below in the
...
<dt><strong>None</strong> <span class="classifier-delimiter">:</span> <span class="classifier">The input file’s primary headers is updated with the computed sky value.</span></dt>
<dd></dd>
</dl>
</td>
</tr>
...
<dd><p class="first last">Turn on or off sky subtraction on the input data. When <code class="xref py py-obj docutils literal notranslate"><span class="pre">skysub</span></code> is set
to <code class="xref py py-obj docutils literal notranslate"><span class="pre">no</span></code>, then <code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code> field will be enabled and if user specifies a header
...
If user sets <code class="xref py py-obj docutils literal notranslate"><span class="pre">skysub</span></code> to <code class="xref py py-obj docutils literal notranslate"><span class="pre">yes</span></code> then <code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code> field will be disabled
(and if it is not empty - it will be ignored) and user can use one of the
methods available through the <code class="xref py py-obj docutils literal notranslate"><span class="pre">skymethod</span></code> parameter to compute the sky
or provide a file (see <code class="xref py py-obj docutils literal notranslate"><span class="pre">skyfile</span></code> parameter) with values that should be
subtracted from (single) drizzled images.</p>
</dd>
<dt><strong>skymethod</strong> <span class="classifier-delimiter">:</span> <span class="classifier">{‘localmin’, ‘globalmin+match’, ‘globalmin’, ‘match’}, optional (Default = ‘localmin’)</span></dt>
...
subtraction in the <a class="reference external" href="https://docs.python.org/2/library/functions.html#input" title="(in Python v2.7)"><code class="xref py py-obj docutils literal notranslate"><span class="pre">input</span></code></a> parameter) in an input image,
...
because it computes relative sky values while <code class="xref py py-obj docutils literal notranslate"><span class="pre">astrodrizzle</span></code> needs
...
<dt><strong>skywidth</strong> <span class="classifier-delimiter">:</span> <span class="classifier">float, optional (Default Value = 0.1)</span></dt>
<dd><p class="first last">Bin width, in sigma, used to sample the distribution of pixel flux values in order to compute the sky background statistics.</p>
</dd>
<dt><strong>skystat</strong> <span class="classifier-delimiter">:</span> <span class="classifier">{‘median’, ‘mode’, ‘mean’}, optional (Default Value = ‘median’)</span></dt>
<dd><p class="first last">Statistical method for determining the sky value from the image pixel values.</p>
</dd>
<dt><strong>skylower</strong> <span class="classifier-delimiter">:</span> <span class="classifier">float, optional (Default Value = INDEF)</span></dt>
<dd><p class="first last">Lower limit of usable pixel values for computing the sky. This value should be specified in the units of the input image.</p>
</dd>
<dt><strong>skyupper</strong> <span class="classifier-delimiter">:</span> <span class="classifier">float, optional (Default Value = INDEF)</span></dt>
<dd><p class="first last">Upper limit of usable pixel values for computing the sky. This value should be specified in the units of the input image.</p>
</dd>
<dt><strong>skyclip</strong> <span class="classifier-delimiter">:</span> <span class="classifier">int, optional (Default Value = 5)</span></dt>
<dd><p class="first last">Number of clipping iterations to use when computing the sky value.</p>
</dd>
<dt><strong>skylsigma</strong> <span class="classifier-delimiter">:</span> <span class="classifier">float, optional (Default Value = 4.0)</span></dt>
<dd><p class="first last">Lower clipping limit, in sigma, used when computing the sky value.</p>
</dd>
<dt><strong>skyusigma</strong> <span class="classifier-delimiter">:</span> <span class="classifier">float, optional (Default Value = 4.0)</span></dt>
<dd><p class="first last">Upper clipping limit, in sigma, used when computing the sky value.</p>
</dd>
<dt><strong>skymask_cat</strong> <span class="classifier-delimiter">:</span> <span class="classifier">str, optional (Default Value = ‘’)</span></dt>
<dd><p class="first last">File name of a catalog file listing user masks to be used with images.</p>
</dd>
<dt><strong>use_static</strong> <span class="classifier-delimiter">:</span> <span class="classifier">bool, optional (Default Value = True)</span></dt>
<dd><p class="first last">Specifies whether or not to use static mask to exclude masked image pixels from sky computations.</p>
</dd>
<dt><strong>sky_bits</strong> <span class="classifier-delimiter">:</span> <span class="classifier">int, None, optional (Default = 0)</span></dt>
<dd><p class="first">Integer sum of all the DQ bit values from the input image’s DQ array that should be considered “good” when building masks for sky computations. For example, if pixels in the DQ array can be combinations of 1, 2, 4, and 8 flags and one wants to consider DQ “defects” having flags 2 and 4 as being acceptable for sky computations, then <code class="xref py py-obj docutils literal notranslate"><span class="pre">sky_bits</span></code> should be set to 2+4=6. Then a DQ pixel having values 2,4, or 6 will be considered a good pixel, while a DQ pixel with a value, e.g., 1+2=3, 4+8=12, etc. will be flagged as a “bad” pixel.</p>
...
<div class="line-block">
<div class="line">Set <code class="xref py py-obj docutils literal notranslate"><span class="pre">sky_bits</span></code> to <a class="reference external" href="https://docs.python.org/2/library/constants.html#None" title="(in Python v2.7)"><code class="xref py py-obj docutils literal notranslate"><span class="pre">None</span></code></a> to turn off the use of image’s DQ array for sky computations.</div>
</div>
...
<dt><strong>skyfile</strong> <span class="classifier-delimiter">:</span> <span class="classifier">str, optional (Default Value = ‘’)</span></dt>
<dd><p class="first last">Name of file containing user-computed sky values to be used with each input image. This ASCII file should only contain 2 columns: image filename in column 1 and sky value in column 2.  The sky value should be provided in units that match the units of the input image and for multi-chip images, the same value will be applied to all chips.</p>
</dd>
...
from the image by the user. The <code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code> parameter is ignored when
<code class="xref py py-obj docutils literal notranslate"><span class="pre">skysub</span></code> is set to <code class="xref py py-obj docutils literal notranslate"><span class="pre">yes</span></code>.</p>
<div class="last admonition note">
<p class="first admonition-title">Note</p>
<p class="last">When <code class="xref py py-obj docutils literal notranslate"><span class="pre">skysub`=`no</span></code> and <code class="xref py py-obj docutils literal notranslate"><span class="pre">skyuser</span></code> field is empty, then <code class="xref py py-obj docutils literal notranslate"><span class="pre">AstroDrizzle</span></code> will
assume that sky background is 0.0 for the purpose of cosmic-ray rejection.</p>
</div>
</dd>
<dt><strong>in_memory</strong> <span class="classifier-delimiter">:</span> <span class="classifier">bool, optional (Default Value = False)</span></dt>
<dd><p class="first last">Specifies whether to optimize execution for speed (maximum memory usage) or use a balanced approach in which a minimal amount of image data is kept in memory and retrieved from disk as needed. The default setting is recommended for most systems.</p>
</dd>
</dl>
</td>
</tr>
...
<p><a class="reference internal" href="#drizzlepac.sky.sky" title="drizzlepac.sky.sky"><code class="xref py py-func docutils literal notranslate"><span class="pre">sky()</span></code></a> provides new algorithms for sky value computations
...
(see parameter <a class="reference external" href="https://docs.python.org/2/library/functions.html#input" title="(in Python v2.7)"><code class="xref py py-obj docutils literal notranslate"><span class="pre">input</span></code></a>).</p>
<p>See help for <code class="xref py py-func docutils literal notranslate"><span class="pre">skypac.parseat.parse_at_line()</span></code> for details
...
<code class="xref py py-class docutils literal notranslate"><span class="pre">SkyLine</span></code> class.</li>
<li>Each <code class="xref py py-class docutils literal notranslate"><span class="pre">SkyLine</span></code> object contains one or more
<code class="xref py py-class docutils literal notranslate"><span class="pre">SkyLineMember</span></code> objects that manage
...
<li><p class="first"><a class="reference internal" href="#drizzlepac.sky.sky" title="drizzlepac.sky.sky"><code class="xref py py-func docutils literal notranslate"><span class="pre">sky()</span></code></a> works directly on <em>geometrically distorted</em>
...
sources in the image. As discussed above, <a class="reference internal" href="#drizzlepac.sky.sky" title="drizzlepac.sky.sky"><code class="xref py py-func docutils literal notranslate"><span class="pre">sky()</span></code></a>
...
Alternatively, one can use <code class="xref py py-obj docutils literal notranslate"><span class="pre">upper</span></code> parameter to limit the use of
...
<p>Something to keep in mind is that the full <code class="xref py py-obj docutils literal notranslate"><span class="pre">AstroDrizzle</span></code> interface will
make backup copies of your original files and place them in the <code class="docutils literal notranslate"><span class="pre">OrIg/</span></code>
...
value from each <code class="docutils literal notranslate"><span class="pre">*flt.fits</span></code> image in the current directory,
saving the output file with the extension of “mysky”:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">drizzlepac</span> <span class="k">import</span> <span class="n">sky</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">sky</span><span class="o">.</span><span class="n">sky</span><span class="p">(</span><span class="s1">&#39;*flt.fits&#39;</span><span class="p">,</span><span class="n">outExt</span><span class="o">=</span><span class="s1">&#39;mysky&#39;</span><span class="p">)</span>
</pre></div>
</div>
</dd></dl>
...
<code class="descclassname">drizzlepac.sky.</code><code class="descname">help</code><span class="sig-paren">(</span><em>file=None</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/drizzlepac/sky.html#help"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#drizzlepac.sky.help" title="Permalink to this definition">¶</a></dt>
...
writing out the help.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="adrizzle.html" class="btn btn-neutral float-right" title="Step 4 and 8: Drizzling the Images" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="static.html" class="btn btn-neutral" title="Step 2: Generate a Static Mask" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
