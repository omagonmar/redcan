...
<head>
  ...
  <title>drizzlepac.tweakutils &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
...
<span class="kn">from</span> <span class="nn">stsci.tools</span> <span class="k">import</span> <span class="n">asnutil</span><span class="p">,</span> <span class="n">irafglob</span><span class="p">,</span> <span class="n">parseinput</span><span class="p">,</span> <span class="n">fileutil</span><span class="p">,</span> <span class="n">logutil</span>
...
<span class="n">__all__</span> <span class="o">=</span> <span class="p">[</span>
    <span class="s1">&#39;parse_input&#39;</span><span class="p">,</span> <span class="s1">&#39;atfile_sci&#39;</span><span class="p">,</span> <span class="s1">&#39;parse_atfile_cat&#39;</span><span class="p">,</span> <span class="s1">&#39;ndfind&#39;</span><span class="p">,</span>
    <span class="s1">&#39;get_configobj_root&#39;</span><span class="p">,</span> <span class="s1">&#39;isfloat&#39;</span><span class="p">,</span> <span class="s1">&#39;parse_skypos&#39;</span><span class="p">,</span> <span class="s1">&#39;make_val_float&#39;</span><span class="p">,</span>
    <span class="s1">&#39;radec_hmstodd&#39;</span><span class="p">,</span> <span class="s1">&#39;parse_exclusions&#39;</span><span class="p">,</span> <span class="s1">&#39;parse_colname&#39;</span><span class="p">,</span> <span class="s1">&#39;readcols&#39;</span><span class="p">,</span>
    <span class="s1">&#39;read_FITS_cols&#39;</span><span class="p">,</span> <span class="s1">&#39;read_ASCII_cols&#39;</span><span class="p">,</span> <span class="s1">&#39;write_shiftfile&#39;</span><span class="p">,</span> <span class="s1">&#39;createWcsHDU&#39;</span><span class="p">,</span>
    <span class="s1">&#39;idlgauss_convolve&#39;</span><span class="p">,</span> <span class="s1">&#39;gauss_array&#39;</span><span class="p">,</span> <span class="s1">&#39;gauss&#39;</span><span class="p">,</span> <span class="s1">&#39;make_vector_plot&#39;</span><span class="p">,</span>
    <span class="s1">&#39;apply_db_fit&#39;</span><span class="p">,</span> <span class="s1">&#39;write_xy_file&#39;</span><span class="p">,</span> <span class="s1">&#39;find_xy_peak&#39;</span><span class="p">,</span> <span class="s1">&#39;plot_zeropoint&#39;</span><span class="p">,</span>
    <span class="s1">&#39;build_xy_zeropoint&#39;</span><span class="p">,</span> <span class="s1">&#39;build_pos_grid&#39;</span>
<span class="p">]</span>
...
<span class="k">def</span> <span class="nf">ndfind</span><span class="p">(</span><span class="n">array</span><span class="p">,</span> <span class="n">hmin</span><span class="p">,</span> <span class="n">fwhm</span><span class="p">,</span> <span class="n">skymode</span><span class="p">,</span>
           ...
           <span class="n">mask</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">use_sharp_round</span><span class="o">=</span><span class="kc">False</span><span class="p">,</span> <span class="n">nbright</span><span class="o">=</span><span class="kc">None</span><span class="p">):</span>

    <span class="n">star_list</span><span class="p">,</span> <span class="n">fluxes</span><span class="o">=</span> <span class="n">findobj</span><span class="o">.</span><span class="n">findstars</span><span class="p">(</span>
        <span class="n">array</span><span class="p">,</span> <span class="n">fwhm</span><span class="p">,</span> <span class="n">hmin</span><span class="p">,</span> <span class="n">skymode</span><span class="p">,</span>
    ...
    <span class="n">star_list</span> <span class="o">=</span> <span class="nb">list</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">array</span><span class="p">(</span><span class="n">star_list</span><span class="p">)</span><span class="o">.</span><span class="n">T</span><span class="p">)</span>
    <span class="n">fluxes</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">array</span><span class="p">(</span><span class="n">fluxes</span><span class="p">,</span> <span class="n">np</span><span class="o">.</span><span class="n">float</span><span class="p">)</span>
    ...
    <span class="k">if</span> <span class="n">nbright</span> <span class="ow">is</span> <span class="ow">not</span> <span class="kc">None</span><span class="p">:</span>
        <span class="n">idx</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">argsort</span><span class="p">(</span><span class="n">fluxes</span><span class="p">)[::</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>
        <span class="n">fluxes</span> <span class="o">=</span> <span class="n">fluxes</span><span class="p">[</span><span class="n">idx</span><span class="p">]</span>
        <span class="n">star_list</span> <span class="o">=</span> <span class="p">[</span><span class="n">s</span><span class="p">[</span><span class="n">idx</span><span class="p">]</span> <span class="k">for</span> <span class="n">s</span> <span class="ow">in</span> <span class="n">star_list</span><span class="p">]</span>

    <span class="k">if</span> <span class="n">use_sharp_round</span><span class="p">:</span>
        <span class="k">return</span> <span class="p">(</span><span class="n">star_list</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">star_list</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="n">fluxes</span><span class="p">,</span>
                <span class="n">np</span><span class="o">.</span><span class="n">arange</span><span class="p">(</span><span class="n">star_list</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">size</span><span class="p">),</span>
                <span class="n">star_list</span><span class="p">[</span><span class="mi">2</span><span class="p">],</span> <span class="n">star_list</span><span class="p">[</span><span class="mi">3</span><span class="p">],</span> <span class="n">star_list</span><span class="p">[</span><span class="mi">4</span><span class="p">])</span>
    <span class="k">else</span><span class="p">:</span>
        <span class="k">return</span> <span class="p">(</span><span class="n">star_list</span><span class="p">[</span><span class="mi">0</span><span class="p">],</span> <span class="n">star_list</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="n">fluxes</span><span class="p">,</span>
                <span class="n">np</span><span class="o">.</span><span class="n">arange</span><span class="p">(</span><span class="n">star_list</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span><span class="o">.</span><span class="n">size</span><span class="p">),</span> <span class="kc">None</span><span class="p">,</span> <span class="kc">None</span><span class="p">,</span> <span class="kc">None</span><span class="p">)</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="k">if</span> <span class="n">vector</span><span class="p">:</span>
        ...
        <span class="n">plt</span><span class="o">.</span><span class="n">title</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;$Vector\ plot\ of\ </span><span class="si">%d</span><span class="s2">/</span><span class="si">%d</span><span class="s2">\ residuals:\ </span><span class="si">%s</span><span class="s2">$&quot;</span><span class="o">%</span><span class="p">(</span>
    ...
    <span class="k">else</span><span class="p">:</span>
        ...
        <span class="k">else</span><span class="p">:</span>
            ...
            <span class="n">fig</span><span class="o">.</span><span class="n">suptitle</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;$&quot;</span><span class="o">+</span><span class="n">title</span><span class="o">+</span><span class="s2">&quot;$&quot;</span><span class="p">,</span><span class="n">ha</span><span class="o">=</span><span class="s1">&#39;center&#39;</span><span class="p">,</span> <span class="n">fontsize</span><span class="o">=</span><span class="n">labelsize</span><span class="o">+</span><span class="mi">6</span><span class="p">)</span>
...
<span class="sd">    &quot;&quot;&quot;</span>
    ...
    <span class="n">plt</span><span class="o">.</span><span class="n">viridis</span><span class="p">()</span>
