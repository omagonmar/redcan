...
<head>
  ...
  <title>Step 7: Cosmic-ray identification &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Step 7: Cosmic-ray identification</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Step 7: Cosmic-ray identification</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/drizcr.rst.txt" rel="nofollow"> View page source</a>
...
can be created through the use of the <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr_corr</span></code> parameter.</p>
<table class="docutils field-list" frame="void" rules="none">
<col class="field-name" />
<col class="field-body" />
<tbody valign="top">
...
<dd><p class="first last">A python list of blotted median image filenames, or just a single
filename.</p>
</dd>
<dt><strong>configObj</strong> <span class="classifier-delimiter">:</span> <span class="classifier">configObject (Default = None)</span></dt>
<dd><p class="first last">An instance of <code class="xref py py-obj docutils literal notranslate"><span class="pre">configObject</span></code> which overrides default parameter settings.</p>
</dd>
...
<dd><p class="first last">An optional list of parameters specified by the user, which can also
...
<dt><strong>driz_cr</strong> <span class="classifier-delimiter">:</span> <span class="classifier">bool (Default = False)</span></dt>
<dd><p class="first last">Perform cosmic-ray detection? If set to <code class="docutils literal notranslate"><span class="pre">True</span></code>, cosmic-rays will be
detected and used to create cosmic-ray masks based on the algorithms
from <code class="xref py py-obj docutils literal notranslate"><span class="pre">deriv</span></code> and <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr</span></code>.</p>
</dd>
<dt><strong>driz_cr_corr</strong> <span class="classifier-delimiter">:</span> <span class="classifier">bool (Default = False)</span></dt>
<dd><p class="first last">Create a cosmic-ray cleaned input image? I set to <a class="reference external" href="https://docs.python.org/2/library/constants.html#True" title="(in Python v2.7)"><code class="xref py py-obj docutils literal notranslate"><span class="pre">True</span></code></a>, a cosmic-ray
cleaned <code class="docutils literal notranslate"><span class="pre">_cor</span></code> image will be generated directly from the input image,
and a corresponding <code class="docutils literal notranslate"><span class="pre">_crmask</span></code> file will be written to document detected
...
<dd><p class="first last">The values for this parameter specify the signal-to-noise ratios for
the <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr</span></code> task to be used in detecting cosmic rays.
See the help file for <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr</span></code> for further discussion of this parameter.</p>
</dd>
<dt><strong>driz_cr_grow</strong> <span class="classifier-delimiter">:</span> <span class="classifier">int (Default = 1)</span></dt>
<dd><p class="first last">The radius, in pixels, around each detected cosmic-ray,
...
<dd><p class="first last">Length, in pixels, of the CTE tail that should be masked in
...
<dd><p class="first last">Scaling factor applied to the derivative in <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr</span></code> when detecting
cosmic-rays. See the help file for <code class="xref py py-obj docutils literal notranslate"><span class="pre">driz_cr</span></code> for further discussion
of this parameter.</p>
</dd>
</dl>
</td>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">drizzlepac</span> <span class="k">import</span> <span class="n">drizCR</span>
...
which also been updated with the user overrides.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="ablot.html" class="btn btn-neutral" title="Step 6: Blotting the Median Image" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
