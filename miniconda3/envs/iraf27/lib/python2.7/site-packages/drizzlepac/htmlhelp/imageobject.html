...
<head>
  ...
  <title>imageObject Classes &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
    ...
    <link rel="top" title="DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation" href="index.html"/>
        <link rel="next" title="Base ImageObject Classes" href="baseobjects.html"/>
        <link rel="prev" title="Primary User Interface: AstroDrizzle()" href="astrodrizzle.html"/> 
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">imageObject Classes</a><ul>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>imageObject Classes</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/imageobject.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="imageobject-classes">
<span id="imageobject"></span><span id="imageobjects"></span><h1>imageObject Classes<a class="headerlink" href="#imageobject-classes" title="Permalink to this headline">¶</a></h1>
<p>This class and related sub-classes manage all the instrument-specific
images for processing by <code class="xref py py-obj docutils literal notranslate"><span class="pre">AstroDrizzle</span></code>.</p>
<div class="graphviz"><object data="_images/inheritance-fbd567312ddf42a4b0a8a9df820d36ba3a051468.svg" type="image/svg+xml" class="inheritance graphviz">
<p class="warning">Inheritance diagram of drizzlepac.imageObject, drizzlepac.acsData, drizzlepac.wfc3Data, drizzlepac.wfpc2Data, drizzlepac.nicmosData, drizzlepac.stisData</p></object></div>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="baseobjects.html">Base ImageObject Classes</a></li>
<li class="toctree-l1"><a class="reference internal" href="acsobjects.html">ACS ImageObjects</a></li>
<li class="toctree-l1"><a class="reference internal" href="wfc3objects.html">WFC3 ImageObjects</a></li>
<li class="toctree-l1"><a class="reference internal" href="stisobjects.html">STIS ImageObjects</a></li>
<li class="toctree-l1"><a class="reference internal" href="nicmosobjects.html">NICMOS ImageObjects</a></li>
<li class="toctree-l1"><a class="reference internal" href="wfpc2objects.html">WFPC2 ImageObjects</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="baseobjects.html" class="btn btn-neutral float-right" title="Base ImageObject Classes" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="astrodrizzle.html" class="btn btn-neutral" title="Primary User Interface: AstroDrizzle()" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
