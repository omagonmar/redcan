...
<head>
  ...
  <title>Refmagefindpars: Source finding parameters for the reference image &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
...
<li class="toctree-l1 current"><a class="current reference internal" href="#">Refmagefindpars: Source finding parameters for the reference image</a></li>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>Refmagefindpars: Source finding parameters for the reference image</li>
      <li class="wy-breadcrumbs-aside">
        
          
            <a href="_sources/refimagefindpars.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="refmagefindpars-source-finding-parameters-for-the-reference-image">
<span id="refimagefindpars"></span><h1>Refmagefindpars: Source finding parameters for the reference image<a class="headerlink" href="#refmagefindpars-source-finding-parameters-for-the-reference-image" title="Permalink to this headline">¶</a></h1>
<p>This interface provides a mechanism for setting the parameters used by the
built-in source finding algorithm based on the published algorithms
used by DAOFIND. These settings apply only to source finding
in the reference images.</p>
...
sources from the reference image (if specified) as called by <a class="reference internal" href="tweakreg.html#tweakreg"><span class="std std-ref">TWEAKREG: Alignment of Images</span></a>.
The algorithm implemented follows the concepts defined by <code class="docutils literal notranslate"><span class="pre">DAOFIND</span></code>
(without actually using any <code class="docutils literal notranslate"><span class="pre">DAOFIND</span></code> code).</p>
...
<code class="descclassname">drizzlepac.refimagefindpars.</code><code class="descname">getHelpAsString</code><span class="sig-paren">(</span><em>docstring=False</em>, <em>show_ver=True</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/drizzlepac/refimagefindpars.html#getHelpAsString"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#drizzlepac.refimagefindpars.getHelpAsString" title="Permalink to this definition">¶</a></dt>
...
<code class="descclassname">drizzlepac.refimagefindpars.</code><code class="descname">help</code><span class="sig-paren">(</span><em>file=None</em><span class="sig-paren">)</span><a class="reference internal" href="_modules/drizzlepac/refimagefindpars.html#help"><span class="viewcode-link">[source]</span></a><a class="headerlink" href="#drizzlepac.refimagefindpars.help" title="Permalink to this definition">¶</a></dt>
...
writing out the help.</p>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="imagefindpars.html" class="btn btn-neutral float-right" title="Imagefindpars: Source finding parameters" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="tweakreg.html" class="btn btn-neutral" title="TWEAKREG: Alignment of Images" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
