...
<head>
  ...
  <title>Utilities &mdash; DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation</title>
    ...
    <link rel="top" title="DrizzlePac 2.2.6 (2018-11-02 15:37:13 -0400) documentation" href="index.html"/>
        <link rel="next" title="Utility Functions" href="utilfuncs.html"/>
        <link rel="prev" title="Step 7: Cosmic-ray identification" href="drizcr.html"/> 
...
<li class="toctree-l2"><a class="reference internal" href="utilfuncs.html">Utility Functions</a></li>
<li class="toctree-l2"><a class="reference internal" href="wcsutils.html">WCS Utilities</a></li>
<li class="toctree-l2"><a class="reference internal" href="outimage.html">Output Image Generation</a></li>
<li class="toctree-l2"><a class="reference internal" href="mdztab.html">MultiDrizzle Reference Table</a></li>
</ul>
</li>
...
<p>Various utilities get used by <code class="xref py py-obj docutils literal notranslate"><span class="pre">Multidrizzle</span></code>, including some to handle WCS
interpretation, trailer file generation, output file generation
and interpretation of the <code class="docutils literal notranslate"><span class="pre">MDRIZTAB</span></code> reference file.</p>
<div class="toctree-wrapper compound">
<ul>
<li class="toctree-l1"><a class="reference internal" href="utilfuncs.html">Utility Functions</a></li>
<li class="toctree-l1"><a class="reference internal" href="wcsutils.html">WCS Utilities</a></li>
<li class="toctree-l1"><a class="reference internal" href="outimage.html">Output Image Generation</a></li>
<li class="toctree-l1"><a class="reference internal" href="mdztab.html">MultiDrizzle Reference Table</a></li>
</ul>
</div>
</div>
    ...
    <div class="rst-footer-buttons" role="navigation" aria-label="footer navigation">
        ...
        <a href="utilfuncs.html" class="btn btn-neutral float-right" title="Utility Functions" accesskey="n">Next <span class="fa fa-arrow-circle-right"></span></a>
      
      
        <a href="drizcr.html" class="btn btn-neutral" title="Step 7: Cosmic-ray identification" accesskey="p"><span class="fa fa-arrow-circle-left"></span> Previous</a>
