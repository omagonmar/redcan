...
export CPU_COUNT="1"
export RECIPE_DIR="/rtfproc/ac_build/astroconda-iraf/iraf.nfextern"
export CONDA_PY="27"
...
export SRC_DIR="/rtfproc/anaconda2_4.2.0/conda-bld/iraf.nfextern_1553892562127/work"
