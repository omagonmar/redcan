...
# MKIMHDR -- Create a minimal IMIO header structure.
# Use mfree to free the structure.

pointer procedure mkimhdr (ndim, len_hdr)
...
# IM2TB -- Copy image header to table header.

procedure im2tb (im, tp)
...
# TB2IM -- Convert table header to image header.

procedure tb2im (tp, im)
...
# IM2IM -- Copy image header to image header.

procedure im2im (im1, im2)
