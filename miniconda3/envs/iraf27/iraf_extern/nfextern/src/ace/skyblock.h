...
define	SKB_LEN			89	# Sky block structure length
...
define	SKB_NSKYUT	Memi[$1+76]	# Ptr to num sky pix
define	SKB_SKYSUT	Memi[$1+77]	# Ptr to thresholded sky block values
define	SKB_SIGSUT	Memi[$1+78]	# Ptr to sigma block values
define	SKB_SKYUT	Memi[$1+79]	# Ptr to current sky block line
define	SKB_SIGUT	Memi[$1+80]	# Ptr to current sigma block line
define	SKB_NSKY	Memi[$1+81]	# Ptr to num sky pix
define	SKB_EXP		Memi[$1+82]	# Ptr to exposure values
define	SKB_SKYS	Memi[$1+83]	# Ptr to thresholded sky block values
define	SKB_SIGS	Memi[$1+84]	# Ptr to sigma block values
define	SKB_SKY		Memi[$1+85]	# Ptr to current sky block line
define	SKB_SIG		Memi[$1+86]	# Ptr to current sigma block line

# The following are computed for each image.
define	SKB_AVSKY	Memr[P2R($1+87)]	# Mean sky
define	SKB_AVSIG	Memr[P2R($1+88)]	# Mean sigma
