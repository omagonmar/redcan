...
define	SF_SZFNAME	99		 # Length of file names
...
define	SF_HELP		Memc[P2C($1+50)] # Help file
...
define	SFD_DATA	Memi[$1+50]	 # Pointer to real image raster
define	SFD_RADIUS	Memr[P2R($1+51)] # Profile radius
define	SFD_NP		Memi[$1+52]	 # Number of profile points
define	SFD_NPMAX	Memi[$1+53]	 # Maximum number of profile points
define	SFD_X1		Memi[$1+54]	 # Image raster limits
define	SFD_X2		Memi[$1+55]
define	SFD_Y1		Memi[$1+56]
define	SFD_Y2		Memi[$1+57]
define	SFD_ID		Memi[$1+58]	 # Star ID
define	SFD_F		Memr[P2R($1+59)] # Focus
define	SFD_RA		Memd[P2D($1+60)] # RA (hours)
define	SFD_DEC		Memd[P2D($1+62)] # DEC (deg)
define	SFD_X		Memr[P2R($1+64)] # Star X position
define	SFD_Y		Memr[P2R($1+65)] # Star Y position
define	SFD_W		Memr[P2R($1+66)] # Width to use
define	SFD_M		Memr[P2R($1+67)] # Magnitude
define	SFD_E		Memr[P2R($1+68)] # Ellipticity
define	SFD_PA		Memr[P2R($1+69)] # Position angle
define	SFD_R		Memr[P2R($1+70)] # Radius at given level
define	SFD_DFWHM	Memr[P2R($1+71)] # Direct FWHM
define	SFD_GFWHM	Memr[P2R($1+72)] # Gaussian FWHM
define	SFD_MFWHM	Memr[P2R($1+73)] # Moffat FWHM
define	SFD_ASI1	Memi[$1+74]	 # Pointer to enclosed flux profile
define	SFD_ASI2	Memi[$1+75]	 # Pointer to derivative profile
define	SFD_YP1		Memr[P2R($1+76)] # Minimum of derivative profile
define	SFD_YP2		Memr[P2R($1+77)] # Maximum of derivative profile
define	SFD_FWHM	Memr[P2R($1+$2+77)] # FWHM vs level=0.5*i (i=1-19)
define	SFD_BKGD	Memr[P2R($1+97)] # Background value
define	SFD_BKGD1	Memr[P2R($1+98)] # Original background value
define	SFD_MISO	Memr[P2R($1+99)] # Moment isophote
define	SFD_SIGMA	Memr[P2R($1+100)]# Moffat alpha
define	SFD_ALPHA	Memr[P2R($1+101)]# Moffat alpha
define	SFD_BETA	Memr[P2R($1+102)]# Moffat beta
define	SFD_STATUS	Memi[$1+103]	 # Status
define	SFD_NSAT	Memi[$1+104]	 # Number of saturated pixels
define	SFD_SFS		Memi[$1+105]	 # Pointer to star group
define	SFD_SFF		Memi[$1+106]	 # Pointer to focus group
define	SFD_SFI		Memi[$1+107]	 # Pointer to image group
...
define	SFI_N		Memi[$1+50]	 # Number in imagE
define	SFI_NSFD	Memi[$1+51]	 # Number of data points
define	SFI_SFD		Memi[$1+$2+51]	 # Array of data structures
