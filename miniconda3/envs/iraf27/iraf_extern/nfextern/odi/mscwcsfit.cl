# MSCWCSFIT -- Run TPEAK on a Mosaic image given a list of celestial coords.
# The input is a list of WCS calibrated images and a list of ra(hours),
# dec(degrees), and optional integer id.

procedure mscwcsfit (images, coordinates, database)
...
begin
	...
	while (fscan (fdimages, image) != EOF) {
	    ...
	    mktpeaktab (temp4, temp3, centered-)
	    delete (temp4, verify-)
