...
export CPU_COUNT="1"
export RECIPE_DIR="/rtfproc/ac_build/astroconda-iraf/iraf.mscred"
export CONDA_PY="27"
...
export PKG_VERSION="5.04"
export SRC_DIR="/rtfproc/anaconda2_4.2.0/conda-bld/iraf.mscred_1553892262412/work"
