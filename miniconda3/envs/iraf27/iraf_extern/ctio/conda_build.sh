...
export CPU_COUNT="1"
export RECIPE_DIR="/rtfproc/ac_build/astroconda-iraf/iraf.ctio"
export CONDA_PY="27"
...
export SRC_DIR="/rtfproc/anaconda2_4.2.0/conda-bld/iraf.ctio_1553890561847/work"
