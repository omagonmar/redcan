...
bool	verbose
pointer	sp, helpdir, aproposdb, tempname
...
begin
	...
	# Fetch the names of the root help directory
	# file and the new database file.
	call clgstr ("helpdir", Memc[helpdir], SZ_FNAME)
	...
	call app_compile (Memc[helpdir], Memc[tempname], verbose)
...
procedure app_compile (root_helpdir_file, app_db, verbose)
