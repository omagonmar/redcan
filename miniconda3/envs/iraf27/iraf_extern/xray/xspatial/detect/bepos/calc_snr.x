#$Header: /home/pros/xray/xspatial/detect/bepos/RCS/calc_snr.x,v 11.0 1997/11/06 16:31:56 prosb Exp $
#$Log: calc_snr.x,v $
#Revision 11.0  1997/11/06 16:31:56  prosb
#General Release 2.5
#
#Revision 9.0  1995/11/16 18:50:37  prosb
#General Release 2.4
#
#Revision 8.0  1994/06/27  15:12:13  prosb
#General Release 2.3.1
#
#Revision 7.0  93/12/27  18:32:02  prosb
#General Release 2.3
#
#Revision 6.0  93/05/24  16:13:56  prosb
#General Release 2.2
#
#Revision 5.1  93/05/13  11:51:22  janet
#jd - added code for low statistics, subroutine setvar.
#
...
# -------------------------------------------------------------------------
procedure calc_snr (im, debug, yx_cell_size, p_bepos_xy, fcts, scts, snr)
...
#   Take the difference to determine the counts in the frame
      fcts = bcts - scts

#   Correct low counts to reflect poison rather than gausian stats
      call setvar (fcts, ofcts)
...
#   Compute the signal-to-noise ratio 
#   SNR = ((16/9)*C - Q ) / (sqrt(16/9**2)*C + Q*)
      if ( scts > 0.0 ) {
          snr = (1.7777*scts - fcts) / ((1.7777**2*scts + ofcts)**0.5)
      } else {
         snr = 0.0
      }

      if ( debug >= 4 && debug != 10 ) {
        call printf ("Final src and bkgd counts: %f, %f, varcts = %f \n")
         call pargr (scts)
         call pargr (fcts)
         call pargr (ofcts)
      }
