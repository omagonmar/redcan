#$Header: /home/pros/xray/xspectral/source/RCS/hri_coma.x,v 11.0 1997/11/06 16:42:19 prosb Exp $
#$Log: hri_coma.x,v $
#Revision 11.0  1997/11/06 16:42:19  prosb
#General Release 2.5
#
#Revision 9.0  1995/11/16 19:29:54  prosb
#General Release 2.4
#
#Revision 8.0  1994/06/27  17:32:03  prosb
#General Release 2.3.1
#
#Revision 7.0  93/12/27  18:55:47  prosb
#General Release 2.3
#
#Revision 6.0  93/05/24  16:50:35  prosb
#General Release 2.2
#
#Revision 5.0  92/10/29  22:44:37  prosb
#General Release 2.1
#
#Revision 4.0  92/04/27  18:15:20  prosb
#General Release 2.0:  April 1992
#
#Revision 3.3  92/04/07  16:06:51  prosb
#jso - added arguement to call found by flint.
#
#Revision 3.2  92/03/11  12:34:12  prosb
#jso - did not need to co.
#
#Revision 3.1  91/09/22  19:06:11  wendy
#Added
#
#Revision 3.0  91/08/02  01:58:24  prosb
#General Release 1.1
#
#Revision 2.0  91/03/06  23:03:46  pros
#General Release 1.0
#
...
double procedure hri_coma_scatter( energy, angle )
...
int	row		# l: starting index of given row
...
begin
	call interp_index (Memr[angles], cols, angle, angle_index, angle_frac)
	call interp_index (Memr[energies], rows, real(energy),
...
begin
	...
	{
	    do i = 1, cols
		call gargr(Memr[angles + (i - 1)])
	    if( nscan() < cols )
		call coma_error(2)
	} else
	    call coma_end()
	# get the energies and table rows (remaining rows of file)
	do j = 1, rows
	{
	    if( fscan(fd) != EOF )
	    {
		row = (j-1) * cols
		call gargr(Memr[energies + (j - 1)])
		do i = 1, cols
...
procedure coma_error ( i )
int	i	# i: identifier for debug
begin
	call errori(0, "parse failure - HRI scatter+coma table", i)
end
