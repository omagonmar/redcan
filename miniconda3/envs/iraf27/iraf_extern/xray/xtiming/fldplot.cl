...
# -----------------------------------------------------------------------
# Module:	fldplot.cl
# Description:  run the timing plot task with the default params for fld table.
# -----------------------------------------------------------------------
procedure fldplot(table)
    ...
    string  plot_title {"Fold :", prompt="Plot Title",mode="h"}
    string  x_title   {"", prompt="Plot Title",mode="h"}
    ...
    string  x_units    {"phase", prompt="X axis units - phase | seconds | bin",mode="h"}
    real    x_tics     {8., prompt="num x labels",mode="h"}
