...
#
# RCS header:
# $Header: /home/pros/xray/xdataio/hkfilter/RCS/filter.x,v 11.0 1997/11/06 16:37:41 prosb Exp $
# $Log: filter.x,v $
# Revision 11.0  1997/11/06 16:37:41  prosb
# General Release 2.5
#
# Revision 9.0  1995/11/16 19:04:00  prosb
# General Release 2.4
#
#Revision 8.0  1994/06/27  17:00:08  prosb
#General Release 2.3.1
#
#Revision 7.0  93/12/27  18:46:32  prosb
#General Release 2.3
#
#Revision 6.0  93/05/24  16:43:34  prosb
#General Release 2.2
#
#Revision 5.1  93/05/20  09:01:44  mo
#MC	5/20/93		Add support for 'general' TSI records
#
#Revision 5.0  92/10/29  22:39:33  prosb
#General Release 2.1
#
#Revision 4.0  92/06/26  14:34:31  prosb
#General Release 2.0:  April 1992
#
#Revision 1.2  92/06/17  10:45:55  mo
#MC	6/16/92		Replace hardwired tempfile name with mktemp
#
#Revision 1.1  92/03/23  10:08:43  mo
#Initial revision
#
...
begin
	...
	call calloc(FLT_QPN(fptr), SZ_PATHNAME, TY_CHAR)
        call mktemp ("flt", FLT_QPNAME(fptr), SZ_PATHNAME)
...
begin
	...
	# define the macro, if necessary
        if( qp_accessf(FLT_QP(fptr), name) == NO )
            call qp_addf(FLT_QP(fptr), name, "macro", len, "macro def", 0)
