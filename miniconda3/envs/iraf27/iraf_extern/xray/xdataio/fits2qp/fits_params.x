# JCC(6/98) - updated wft_encode_date for Y2K  (YYYY-MM-DD)
#
# JCC(8/97) - wft_encode_date()  [ used in a3d_main_header/qp2fits ]
#                Change the DATE format from dd-mm-yy to dd/mm/yy for the
#                fits header.
#
...
begin
	maxchar = min (maxch, LEN_OBJECT)   #LEN_OBJECT=63
...
begin
        call printf("wft_encode_date\n")
	ctime = clktime (long (0))
	call brktime (ctime, time)

#JCC(6/4/98) - change the DATE format from dd/mm/yy to yyyy-mm-dd
#              QP2FITS write "DATE" to FITS (FITS creation date)
#JCC(8/18/97)- change the DATE format from dd-mm-yy to dd/mm/yy
