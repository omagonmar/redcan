# JCC(6/98) - Y2K: passing LEN_DATE(=10) when calling 
#                  wft_encode_date && wft_encodec.
...
#JCC(6/98) char	datestr[LEN_STRING]
...
#JCC(6/98) - Y2K: passing LEN_DATE(=10) instead of LEN_STRING(=8)
	case KEY_DATE:
	    #jcc-call wft_encode_date (datestr, LEN_STRING)
	    #jcc-call wft_encodec ("DATE", datestr, LEN_STRING, card, "")
	    call wft_encode_date (datestr, LEN_DATE)
	    call wft_encodec ("DATE", datestr, LEN_DATE, card, "")
