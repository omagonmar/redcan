#$Header: /home/pros/xray/xdataio/RCS/_rdfarc2pros.cl,v 11.0 1997/11/06 16:36:05 prosb Exp $
#$Log: _rdfarc2pros.cl,v $
#Revision 11.0  1997/11/06 16:36:05  prosb
#General Release 2.5
#
#Revision 9.1  1997/10/03 21:48:10  prosb
#JCC(10/97) - Add force to strfits.
#
#Revision 9.0  1995/11/16 18:56:37  prosb
#General Release 2.4
#
#Revision 8.6  1995/06/12  17:39:17  prosb
#JCC - Updated to check whether both of the pixel file(*.pix) and the
#      output file exist before using imcopy to create *.pl for pspc.
#      And no need to reproduce other tables after pl file created.
#
#Revision 8.5  1995/05/22  19:16:09  prosb
#JCC - Add PSPC light curve tables.
#    - Remove unnecessary "scan" that was used twice in one pipe line.
#
#Revision 8.3  1995/05/04  16:41:28  prosb
#JCC - Update with latest TABLES 1.3.3 parameter (strfits)
#
#Revision 8.2  94/10/05  13:51:21  dvs
#Added new fits2qp params.
#
#Revision 8.1  94/09/07  17:42:15  janet
#jd - Fixed stridx call when piecing together the mex.pl file name.
#
#Revision 8.0  94/06/27  15:16:51  prosb
#General Release 2.3.1
#
#Revision 7.4  94/06/27  13:35:01  janet
#fixed typo .... errmst1 changed to errmsg1
#
#Revision 7.3  94/05/20  13:45:56  janet
#jd - added 2nd if accecc around imcopy
#
#Revision 7.2  94/05/18  17:38:49  janet
## --- jd fix - 5/94 - added if access before imcopy here
#
#Revision 7.1  94/05/12  17:53:42  janet
#jd - updated upqpoerdf call.
#
#Revision 7.0  93/12/27  18:42:50  prosb
#General Release 2.3
#
#Revision 1.2  93/12/21  14:52:46  mo
#MC		12/22/93		Move error messages to subroutines
#					and add missing HRI history file
#					conversion
#
#Revision 1.1  93/12/16  10:03:26  mo
#Initial revision
#
#
#
# Module:       rdfarc2pros.cl
...
# 		Create HRI PROS Image map - root_im1.imh
    ...
    strfits (inim, " ", outfits, template="none", 
	 long_header=no, short_header=yes, datatype="default", blank=0., 
