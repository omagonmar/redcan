...
export CPU_COUNT="1"
export RECIPE_DIR="/rtfproc/ac_build/astroconda-iraf/iraf.xray"
export CONDA_PY="27"
...
export PKG_VERSION="2.5.y2k"
export SRC_DIR="/rtfproc/anaconda2_4.2.0/conda-bld/iraf.xray_1553895567985/work"
