...
#
procedure dispbufx(buf, ncols, nrows, flip)

complex	buf[ARB]		# i: array to display
int	ncols			# i: number of columns
int	nrows			# i: number of rows
bool	flip			# i: flip display?

complex	pixval			# l: value of current pixel
complex	max			# l: max value in a pixel
complex	total			# l: total counts
