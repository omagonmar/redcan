...
#
procedure dispbufr(buf, ncols, nrows, flip)

real	buf[ARB]		# i: array to display
int	ncols			# i: number of columns
int	nrows			# i: number of rows
bool	flip			# i: flip display?

real	pixval			# l: value of current pixel
real	max			# l: max value in a pixel
real	total			# l: total counts
