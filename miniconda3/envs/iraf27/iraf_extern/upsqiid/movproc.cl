# MOVPROC: 25MAR02 KMM expects IRAF 2.11Export or later
...
# MOVPROC: 22JAN00 KMM modify for UPSQIID including channel offset syntax
# MOVPROC: 17MAY00 KMM modify for UPSQIID including channel offset syntax and
#                       image orientation
#                      replace default for reject_value with -1e7 (was -1e8) to
#                        get setpix to work rith floating point images
#          25MAR02 KMM changes to imcombine parameters for IRAF 2.12
procedure movproc (input, output, flatimage)
