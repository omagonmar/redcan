...
#
# Package script for the quirc package
#
...
task      qflat=quirc$qflat.cl
task      qfastsky=quirc$qfastsky.cl
task      qsky=quirc$qsky.cl
task      qreduce=quirc$qreduce.cl
task      quircinfo=quirc$quircinfo.cl
