...
procedure asrt2d (a, b, c, d, npix)

double	a[ARB], b[ARB]		# Primary input, output arrays
double	c[ARB], d[ARB]		# Secondary input, output arrays
...
begin
	...
	call amovd (c, d, npix)		# in place sort
