...
procedure asrt2r (a, b, c, d, npix)

real	a[ARB], b[ARB]		# Primary input, output arrays
real	c[ARB], d[ARB]		# Secondary input, output arrays
...
begin
	...
	call amovr (c, d, npix)		# in place sort
