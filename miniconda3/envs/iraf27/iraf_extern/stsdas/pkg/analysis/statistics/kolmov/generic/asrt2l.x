...
procedure asrt2l (a, b, c, d, npix)

long	a[ARB], b[ARB]		# Primary input, output arrays
long	c[ARB], d[ARB]		# Secondary input, output arrays
...
begin
	...
	call amovl (c, d, npix)		# in place sort
