...
procedure asrt2s (a, b, c, d, npix)

short	a[ARB], b[ARB]		# Primary input, output arrays
short	c[ARB], d[ARB]		# Secondary input, output arrays
...
begin
	...
	call amovs (c, d, npix)		# in place sort
