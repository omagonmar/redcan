...
procedure asrt2i (a, b, c, d, npix)

int	a[ARB], b[ARB]		# Primary input, output arrays
int	c[ARB], d[ARB]		# Secondary input, output arrays
...
begin
	...
	call amovi (c, d, npix)		# in place sort
