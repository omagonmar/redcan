...
procedure icsubcon (n, fdata, wltemp, name, spectype, nsm, fit)
...
procedure icsubcony (n, fdata, wltemp, name, spectype, nsm, fit, ymin, ymax)
...
procedure recover_icfit_pars (ic,intype)
...
begin
	...
	call ic_gstr (ic, "function", confunc, SZ_LINE)
