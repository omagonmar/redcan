...
export CPU_COUNT="1"
export RECIPE_DIR="/rtfproc/ac_build/astroconda-iraf/iraf.rvsao"
export CONDA_PY="27"
...
export PKG_VERSION="2.7.8"
export SRC_DIR="/rtfproc/anaconda2_4.2.0/conda-bld/iraf.rvsao_1553893057946/work"
